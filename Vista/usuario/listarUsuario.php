                ...
                <?php
                    ...
                    foreach ($listaUsuario as $objUsuario) {                         
                       ...
                       /* echo '
                        ...
                        echo '<td><a href="asignarRol.php?idusuario='.$objUsuario->getidusuario().'" class="btn btn-success">Dar rol</a>  <a href="accion/eliminar_usuario.php?idusuario'.$objUsuario->getidusuario().'" class="btn btn-dark">Deshabilitar</a></td>';
