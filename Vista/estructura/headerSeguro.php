...
<div data-options="region:'north',border:false" style="min-height:250px;height:280px;background:#fff;padding:10px">
     ...
     <div id="logo" align="center"style="width: 100%;height: 110px;background-image: url('../css/images/logo-sis-text-2-(800p).png');
	...
	<div class="easyui-panel" style="padding:5px; background-color:#0d6efd;color:white; width:100%;text-decoration:none; font-size:16px;">
		<a href="../home/paginaSegura.php" class="easyui-linkbutton"  style="padding:5px; background-color:#0d6efd;color:white; font-size: 16px;" data-options="plain:true" >Home</a>
	...
	<div id="mm2" style="width:100px;">	</div>
	<div id="mm3"></div>
	<div id="mm4">
    ...
    <div id="mm5">      
        <div href="../menu/listaMenu.php"> Gesti&oacute;n de Men&uacute;</div>
		<div href="../menu/permisosMenu.php"> Gesti&oacute;n permisos p&aacute;ginas</div>
...
<!--<div data-options="region:'center',title:''" style="height:auto; background-color:#212529;"></div>-->
