...
?>
    <div class="card pt-2" style="width:300px">
        ...
        <div class="card-body text-center">
            ...
            <a href="javascript:void(0)" class="btn btn-warning font-weight-bold" onclick="agregarProducto(<?php echo  $objProducto->getIdproducto(); ?>,<?php echo  $data['idusuario'] ?>)">Agregar</a>
